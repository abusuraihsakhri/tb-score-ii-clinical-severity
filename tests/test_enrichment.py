"""
Automated Pytest for tb-score-ii-clinical-severity Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    WhoTreatmentOutcomeMappingEngine,
    MdrtbRiskStratificationEngine,
    NutritionalStatusIntegrationEngine,
    ArtIntegrationForTbhivCoinfectionEngine,
    SputumCultureConversionTracker,
    ContactTracingProtocolEngine,
    TbscoreiiclinicalseverityEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = TbscoreiiclinicalseverityEnrichmentSuite()
