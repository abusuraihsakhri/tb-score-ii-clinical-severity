"""
FastAPI REST API Server for Tb Score Ii Clinical Severity.
"""
...
app = FastAPI(
    title="Tb Score Ii Clinical Severity API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "tb-score-ii-clinical-severity", "domain": "Antimicrobial Stewardship & Microbiology", "standard": "CLSI M100 / EUCAST / CDC NHSN Guidelines", "version": "3.0.0-ENTERPRISE"}
