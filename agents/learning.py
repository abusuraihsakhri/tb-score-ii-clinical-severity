"""
Autonomous Bayesian Calibration & Active Learning Feedback Engine for tb-score-ii-clinical-severity.
"""
import math
...
class ActiveLearningEngine:
    ...
    def __init__(self, system_name: str = "Tb Score Ii Clinical Severity"):
